      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="font-serif-heading text-xl sm:text-xl sm:text-2xl font-black text-[#0F172A] flex items-center gap-2">
            <ImageIcon className="w-5 sm:w-6 h-5 sm:h-6 text-indigo-500" />
            Banner Management
          </h2>
      ...
      <div className="bg-white border border-[#EEF2F7] rounded-md p-3 sm:p-4 flex flex-col lg:flex-row gap-3 sm:gap-4 items-stretch lg:items-center justify-between shadow-sm">
        <div className="relative w-full lg:w-96">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 sm:py-2.5 rounded-md border border-[#EEF2F7] bg-slate-50/50 text-sm sm:text-xs font-semibold text-[#0F172A] placeholder-[#94A3B8] focus:bg-white focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all"
          />
        </div>

        <div className="flex flex-wrap items-center gap-2 w-full lg:w-auto">
          <div className="flex items-center gap-1.5 bg-[#F8FAFC] border border-[#EEF2F7] px-3 py-2.5 sm:px-3.5 sm:py-2 rounded-md transition-all focus-within:border-indigo-500 focus-within:ring-4 focus-within:ring-indigo-500/10">
          ...
          <button onClick={() => toggleSort("sort_order")} className={`flex items-center gap-1 text-sm sm:text-xs font-bold px-3.5 py-2.5 sm:py-2 rounded-md border transition-all cursor-pointer flex-1 sm:flex-none justify-center ${sortBy === "sort_order" ? "bg-indigo-500 text-white border-indigo-500" : "bg-white text-[#475569] border-[#EEF2F7]"}`}>
            Order <ArrowUpDown className="w-3.5 sm:w-3 h-3.5 sm:h-3 ml-0.5" />
          </button>
          <button onClick={() => toggleSort("title")} className={`flex items-center gap-1 text-sm sm:text-xs font-bold px-3.5 py-2.5 sm:py-2 rounded-md border transition-all cursor-pointer flex-1 sm:flex-none justify-center ${sortBy === "title" ? "bg-indigo-500 text-white border-indigo-500" : "bg-white text-[#475569] border-[#EEF2F7]"}`}>
            Title <ArrowUpDown className="w-3.5 sm:w-3 h-3.5 sm:h-3 ml-0.5" />
          </button>
          <button onClick={() => toggleSort("date")} className={`flex items-center gap-1 text-sm sm:text-xs font-bold px-3.5 py-2.5 sm:py-2 rounded-md border transition-all cursor-pointer flex-1 sm:flex-none justify-center ${sortBy === "date" ? "bg-indigo-500 text-white border-indigo-500" : "bg-white text-[#475569] border-[#EEF2F7]"}`}>
...
<>
            ...
            <div className="hidden lg:block overflow-x-auto">
              <table className="w-full border-collapse text-left">
                <thead>
                  <tr className="bg-[#F8FAFC] border-b border-[#EEF2F7]">
                    <th className="px-6 py-4 text-xs lg:text-[10px] font-black text-[#94A3B8] uppercase tracking-wider">Banner</th>
                    <th className="px-6 py-4 text-xs lg:text-[10px] font-black text-[#94A3B8] uppercase tracking-wider">Position</th>
                    <th className="px-6 py-4 text-xs lg:text-[10px] font-black text-[#94A3B8] uppercase tracking-wider">Order</th>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="min-w-0 max-w-[300px]">
                            ...
                            {banner.subtitle && (
                              <p className="text-xs lg:text-[10px] text-[#64748B] truncate mt-0.5 font-medium">{banner.subtitle}</p>
                            )}
                            {banner.link_url && (
                              <div className="flex items-center gap-1 mt-1">
                                <LinkIcon className="w-3 h-3 text-indigo-400" />
                                <span className="text-[11px] lg:text-[9px] text-indigo-500 truncate">{banner.link_url}</span>
                              </div>
                            )}
                          </div>
                        </div>
