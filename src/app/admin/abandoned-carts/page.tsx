    ...
    <div className="flex flex-col gap-6 text-[#0F172A] font-sans">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={loadStats}
          disabled={loading}
          className="px-4 py-2 bg-white border border-gray-200 text-gray-700 text-sm font-semibold rounded-md hover:bg-gray-50 transition-all flex items-center gap-2 disabled:opacity-50 cursor-pointer"
        >
          ...
          <div className="bg-white rounded-md border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                {recoverResult && (
                  <div className="mt-3 bg-emerald-50 border border-emerald-200 rounded-md p-3 text-sm">
              ...
              <button
                ...
                className="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-bold text-sm rounded-md transition-all flex items-center gap-2 shadow-sm cursor-pointer"
              >
                {recovering ? (
