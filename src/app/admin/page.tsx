      ...
      <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-emerald-50 via-amber-50 to-orange-50 border border-amber-200/40 p-7 sm:p-10">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5">
          <div className="space-y-1.5">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded bg-amber-100 text-xs lg:text-[10px] font-bold text-amber-700 uppercase tracking-[0.12em]">
              Overview
            </span>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-1.5 mt-3">
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-emerald-50 text-[10px] lg:text-[9px] font-bold text-emerald-600 uppercase tracking-wider">
      ...
      <div className="bg-white rounded-lg border border-slate-200/80 shadow-sm overflow-hidden">
        ...
        <div className="px-5 sm:px-6 py-4 border-b border-slate-100">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs lg:text-[10px] text-slate-400 font-medium">Daily revenue, orders &amp; performance targets</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded bg-emerald-50 text-xs lg:text-[10px] font-black text-emerald-700 border border-emerald-200/50">
          ...
          <div className="flex flex-wrap items-center gap-4 sm:gap-6 mt-3 pt-3 border-t border-slate-100">
            <div className="flex items-center gap-2 text-xs lg:text-[10px]">
        ...
        <div className="p-5 sm:p-6">
          <div className="relative">
            ...
            <div className="absolute left-0 top-0 bottom-0 w-12 flex flex-col justify-between py-1">
              <span className="text-[11px] lg:text-[9px] font-semibold text-slate-400">40k</span>
              <span className="text-[11px] lg:text-[9px] font-semibold text-slate-400">30k</span>
              <span className="text-[11px] lg:text-[9px] font-semibold text-slate-400">20k</span>
              <span className="text-[11px] lg:text-[9px] font-semibold text-slate-400">10k</span>
              <span className="text-[11px] lg:text-[9px] font-semibold text-slate-400">0</span>
            </div>
                      ...
                      <div key={d.day} className="flex flex-col items-center gap-1 group relative flex-1">
                        ...
                        <div className="absolute bottom-full mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-10">
                          <div className="bg-white rounded-md border border-slate-200 shadow-xl shadow-slate-200/50 px-3 py-2 min-w-[140px]">
                            <p className="text-xs lg:text-[10px] font-bold text-slate-800 mb-1.5">{d.day}</p>
                            <div className="space-y-1">
                              <div className="flex items-center justify-between gap-3">
                                <span className="flex items-center gap-1 text-[10px] lg:text-[9px] text-slate-500">
                                  <span className="w-1.5 h-1.5 rounded-sm bg-indigo-500" />
                                  Revenue
                                </span>
                                <span className="text-xs lg:text-[10px] font-black text-slate-800">{formatCurrency(d.revenue)}</span>
                              </div>
                              <div className="flex items-center justify-between gap-3">
                                <span className="flex items-center gap-1 text-[10px] lg:text-[9px] text-slate-500">
                                ...
                                <span className="text-xs lg:text-[10px] font-black text-slate-800">{d.orders}</span>
                              </div>
                              ...
                              <div className="flex items-center justify-between gap-3">
                                ...
                                <span className="text-xs lg:text-[10px] font-bold text-indigo-600">{formatCurrency(d.target)}</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        {/* X-axis label */}
                          <span className="text-[11px] lg:text-[9px] font-semibold text-slate-400 mt-1">{d.day}</span>
                      </div>
                    );
                  })}
                </div>
          ...
          <div className="flex items-center justify-between px-5 sm:px-6 py-4 border-b border-slate-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs lg:text-[10px] text-slate-400 font-medium">Latest transactions</p>
              </div>
            </div>
            <Link
              href="/admin/orders"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-slate-50 text-xs lg:text-[10px] font-bold text-slate-600 hover:bg-slate-100 transition-colors border border-slate-200/60"
            >
                ...
                >
                  <div className="flex items-center gap-3.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs lg:text-[10px] text-slate-400 mt-0.5 flex items-center gap-1.5">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4">
                    <span
                      className={`text-xs lg:text-[10px] font-bold uppercase px-2.5 py-1 rounded ${getStatusColor(order.status)}`}
                    >
                      {order.status}
                    </span>
          ...
          <div className="flex items-center justify-between px-5 sm:px-6 py-4 border-b border-slate-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs lg:text-[10px] text-slate-400 font-medium">Items needing attention</p>
              </div>
            </div>
          </div>
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-1.5">
                          ...
                          <span
                            className={`text-xs lg:text-[10px] font-black px-2 py-0.5 rounded-md ${
                              isOut
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 p-5 sm:p-6 shadow-sm">
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            ...
            <p className="text-xs lg:text-[10px] text-slate-400 font-medium">Frequently used admin tasks</p>
          </div>
        </div>
